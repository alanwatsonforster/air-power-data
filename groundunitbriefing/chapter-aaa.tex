...
\note{AAA Values}{
    ...
    \begin{minipage}{\linewidth}
        ...
        \begin{center}
            ...
            \begin{tabularx}{\linewidth}{LrrlrclrrL}
                ...
                DShK-38&5&2/3/4&3/2/1&1&---&\phantom{0}12.7&500&850&AS/MP\\
    ...
    \begin{itemize}
        ...
        \item ZPU-2: Malcolm Pipes gives this a damage rating of 3 (more than the ZPU-4) whereas AS gives it a rating of 1 (equal to the ZPU-1). Pipes gives this hit rolls of 4/3/1 whereas AS gives it 4/3/2. The ZPU-2 should have both hit rolls and damage ratings intermediate to those of the ZPU-1 and ZPU-4, but this is impossible as these only differ by one. The solution in {\AirStr} seems to be a good compromise: give it the hit rolls of the ZPU-4 but the damage rating of the ZPU-1. I adopt the AS values.

        \item ZPU-4 and ZU-23: There are six AAA batteries with rates of fire per mount of about 2000 rounds per minute or more: the M55, ZPU-4, twin Rh-202, M167, ZU-23, and Gemag. After accounting for the \plus{1} modifier for the FCR-R of the M167 and Gemag, all have hit rolls of 5/4/3 except for the ZPU-4 from {\TSOH} (although the one from {\AirStr} does have 5/4/3) and the ZU-23. Furthermore, all of these except for the ZU-23 (both {\AirStr} and {\TSOH} versions) have damage ratings increased by one above their baseline values. It seems that either there is some reason to reduce the effectiveness of the ZPU-4 and ZU-23 compared to these other guns, or perhaps they have inconsistent values rolls. The ZU-23 is undeniably basic, and one might think that would be reason to reduce its effectiveness. However, the TCM-20 is basic too and has both a lower rate of fire than the ZU-23 (1450 compared to 2000) and a smaller caliber (20~mm compared to 23~mm), yet its hit rolls are higher than the ZU-23 in {\TSOH} and its damage rating is the same. I think the best solution is to give the ZPU-4 and ZU-23 the values we would expect from comparing them to other guns with similar rate of fire and caliber. Therefore, I give these guns hit rolls of 5/4/3 and the ZU-23 a damage rating of 3. (I also considered the idea that increasing the rate of fire increases \emph{either} the hit rolls \emph{or} the damage rating. However, while this might explain the ZPU-4 from {\TSOH} and the twin Rh-202, it does not correctly predict the values of the M167 or Gemag.)

        \item Single RH-202: The single Rh-202 has unexpectedly low original hit rolls of 3/2/1 for its rate of fire. The values of 4/3/2 for the ZPU-2 and TCM-20, which have a similar rate of fire, are probably more appropriate.

        \item Twin Rh-202: The twin has an unexpectedly low original damage rating of 2 for its rate of fire. A value of 3, increased by one from the baseline for the caliber, is probably more appropriate. Malcolm Pipes gives values for the Rh-202, but it is not clear whether they are for the single or twin mount. He gives hit rolls of 3/2/1 (equal to the {\AirStr} values for the single mount) but a damage rating of 3 (equal to the value I have adopted for the twin mount). I do not adopt this combination of values either for the single or twin Rh-202.
    ...
    The upper part of the following table shows the original data for gun sections from {\AirStr} (AS), {\EOTG} (EOTG), and {\TSOH} (TSOH), and Malcolm Pipes' 2026 compilation (MP). Again, I have added columns with the caliber, burst rate of fire per mount, and muzzle velocity. Values in red will be subsequently modified.
    ...
    \begin{center}
        ...
        \begin{tabularx}{\linewidth}{LrlllllrrL}
            ...
            Gepard&12&\highlight{4/8/12}&5/4/3&4&W&35&1100&1175&MP\\
            ZSU-57-2&18&5/10/15&2/1/1&5&---&57&240&1000&EOTG/MP\\
            \midrule
            \multicolumn{10}{c}{Modified or Adopted Values}\\
            \midrule
            Mobile ZPU-4&&&4/3/2&&&&\multicolumn{3}{l}{--- to match the ZPU-4}\\
            M163&&&5/4/3&&&&\multicolumn{3}{l}{--- to match the M167}\\
            Panhard&&&3/3/2&&&&\multicolumn{3}{l}{--- to match the M3 TCM-20}\\
    ...
    \begin{itemize}
        ...
        \item Mobile ZPU-4: The original hit rolls for the mobile ZPU-4 section are 3/3/2, but 4/3/2 is predicted from the values of 5/4/3 for the battery and is in better agreement with the values for the M16. Malcolm Pipes gives the section the same hit rolls as the battery, despite the fewer mounts, which does not seem to be correct.

        \item M163: Malcolm Pipes gives the section the same hit rolls as the battery, despite the fewer mounts, which does not seem to be correct. I adopt the {\AirStr} hit rolls, which are in agreement with the empirical model.

        \item Panhard M3 VDA: The Panhard M3 VDA in {\AirStr} has unexpectedly low original hit rolls of 2/2/1 compared to the TCM-20 battery and the M3 TCM-20 section, despite having very similar guns. The values of 3/3/2 given by Malcolm Pipes are in agreement with those of the M3 TCM-20 section and those predicted from the TCM-20 battery.
        ...
        \item Blazer: Malcolm Pipes gives this a maximum altitude of 9 rather than the 10 in {\AirStr}. The Blazer uses a 25~mm gun, and the {\AirStr} value is between that of 23~mm guns (9) and 30~mm guns (11), so I will adopt it. Following the model, the hit rolls would be 6/5/4, but they are limited to 5/4/3.
        ...
        \item M53/59: The original hit rolls for the M53/59 section are 4/3/2. The predicted values of 3/2/1, derived from the modified hit rolls of 4/3/2 for the Oerlikon GDF-001 battery and also from the AMX-30SA after discounting the FCR-W, are probably more appropriate.

        \item Gepard: Malcolm Pipes increases the long range to 12, from 10 in {\AirStr}. This might be correct; perhaps later ammunition give longer range than the GDF-001 and I note that he gives a similar increase to the GDF-005. However, I can find no evidence for such an improvement. I adopt the {\AirStr} value.
...
\subsectionwithtwocounters{BTR-152A ZPU-2/4 Section}{BTR-152A ZPU-2 section}{BTR-152A ZPU-4 section}
...
\note{M15 Section}{
    The M1 is somewhat inferior to the 61-K in rate of fire and muzzle velocity. There is a quote in Wikipedia about using the .50 cals to aim the 37 mm.
...
It is a licensed copy of the French Canon de 75 contre aéronefs modèle 1939 Scheider.
A battery has six gun mounts.
...
The QF 5.25~inch entered service with the British Army in 1942 and was installed in and around London. Late in WW2, seven were installed in Australia and three in New Guinea. Eleven were installed in Gibraltar starting in 1953 and were manned into the early 1980s.
...
\newenvironment{aaaunittable}{
    ...
    \raggedbottom
    \footnotesize
    \begin{longtable}{llcccccccccc@{~}c@{~}cc@{~}c@{~}ccccl}
