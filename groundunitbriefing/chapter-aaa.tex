...
\note{AAA Values}{
    ...
    \begin{minipage}{\linewidth}
        ...
        \begin{center}
            ...
            \begin{tabularx}{\linewidth}{LrrlrclrrL}
                ...
                \midrule
                Oerlikon GDF-005&12&4/8/10&4/3/2&4&L&\phantom{0}35&1100&1175&AS/MP\\
    ...
    \begin{center}
        ...
        \begin{tabularx}{\linewidth}{LrlllllrrL}
            ...
            M53/59&&&3/2/1&&&&\multicolumn{3}{l}{--- to match the AMX-30 DCA}\\
            AMX-30 DCA&&&4/3/2&&R&&\multicolumn{3}{l}{--- does not have FCR-W}\\
...
\begin{withcounters}
    ...
    \note{Oerlikon GDF-001 Battery}{
        ...
        {\MPC} has two versions of this:
        \begin{itemize}
            \item OLK-23 (1959): 12--4/8/10--5/4/3--4.
            \item GDF-005 (1985): 15--4/8/12--3/3/2--4.
        \end{itemize}
    ...
    \note{Oerlikon GDF-005 Battery}{
        ...
        {\MPC} has this with AAA values of 15--4/8/12--3/3/2--4. This has a longer range and higher maximum altitude than the GDF-001. Is this from ammunition with a more powerful charge or from the laser rangefinder? The hit rolls are surprisingly small; they are the same as the Bofors 40 mm L/70 which has a rate of fire of only 330 rounds per minute compared to the 1100 rounds per minute of the GDF; furthermore the GDF-005 has a laser rangefinder.

        I prefer to give the GDF-005 the same maximum altitude and ranges as the GDF-001 and hit rolls increased by \plus{1} for the laser rangefinder.
