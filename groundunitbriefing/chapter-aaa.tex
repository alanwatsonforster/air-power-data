...
\begin{withcounters}
    ...
    \note{HS.661 Battery}{
        ...
        I adopt the AAA values for the AMX-13 DCA section, with no modifier for number of units (as the AMX-13 DCA has two guns) but a \minus{1} modifier for the lack of FCR.
        The adopted AAA values are in agreement with the empirical model.

        WeaponSystems states the HS.661A was used by the Egyptian Army and entered service to 1956 and the HS.66B was used by the Argentine Army. Wikipedia states it was used by the Finish Army from 1962.
