...
\note{AAA Values}{
    ...
    \begin{itemize}
        ...
        \item Oerlikon GDF: The Oerlikon GDF has unexpectedly high original hit rolls of 5/4/3 for its rate of fire. The values of 4/3/2 for the ZPU-2, which has a similar rate of fire, are probably more appropriate. I adopt a maximum altitude of 15 (rather than 12) and maximum range of 12 (rather than 10), to match the Gepard (discussed below).
    ...
    \begin{itemize}
        ...
        \item Gepard: {\MP} increases the long range to 12 (from 10 in {\AirStr}). For the GDF-005, he also increases the maximum altitude to 15 (from 12 in {\AirStr}), but he does not apply this to the Gepard. These increases give the same values as the Bofors 40~mm L/70, and probably reflects the higher muzzle velocity of the 35~mm cannon (1175 m/s compared to 1000 m/s). I adopt the increased range and maximum altitude, and apply a similar change to the Oerlikon GDF.
...
\begin{withcounters}
    ...
    \note{Oerlikon GDF-001 Battery}{
        ...
        The AAA values for the battery are from {\AirStr} with the hit rolls reduced from 5/4/3 to 4/3/2 as described in the extended note above and with the maximum altitude and maximum range increased to 15 and 12.
