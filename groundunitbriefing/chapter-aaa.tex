...
\begin{withcounters}
    ...
    \note{M163 Section}{
        ...
        I have adopted the AAA values, defense strength, and sighting range from {\AirStr}.
        The adopted AAA values are in agreement with the empirical model.
        {\MP} gives the section the same hit rolls as the M167 battery, despite the fewer mounts, which does not seem to be correct.
        The turret is open, so I give this open rather than hard armor protection.
    ...
    \note{Panhard M3 VDA Section}{
        ...
        The Panhard M3 VDA in {\AirStr} has unexpectedly low original hit rolls of 2/2/1 compared to the TCM-20 battery and the M3 TCM-20 section, despite having very similar guns. The values of 3/3/2 given by {\MP} are in agreement with those of the M3 TCM-20 section and those predicted from the TCM-20 battery.
