...
% LTeX: dictionary+=bejesus

\section*{Air Power: Ground-Unit Briefing}
\noindent
\documentdate
...
Much of the data here is adapted from J.D. Webster's {\AirStr}, {\EOTG}, and {\TSOH}, from Malcolm Pipe's extensive compendium of AAA and SAM units, and to a lesser degree from {\APJ}. However, the data have been carefully revised for accuracy and internal consistency, a wider variety of ground-combat units are covered to give a richer experience, and the descriptions of the units and their weapon systems have been expanded.
Extensive notes follow the main text, providing provenance of data, sources of information, and justifications for decisions.
