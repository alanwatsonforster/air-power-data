...
Within the game, units are referred to as a brigades, battalions, companies/batteries, and platoons according to their size. However, some forces use other terms, but not always with the same correspondence. The \href{table:unit-terminology-table}{Unit Terminology Table} gives examples of some of these uses.

\begin{table}[h]
    \caption*{\hypertarget{table:unit-terminology-table}{Unit Terminology Table}}
    \centering
    \scriptsize
...
\orderofbattle{Task Force Mercedes}{goose-green-12-infantry-regiment}{
    ...
    The main body of the force was \emph{Regimento de Infantería 12} (12th Infantry Regiment), with three line companies A/B/C, and reinforced with C company of 25th Infantry Regiment.
