...
% LTeX: dictionary+=Aspide
% LTeX: dictionary+=Bofors
% LTeX: dictionary+=Contraves
...
% LTeX: dictionary+=RadioNerds
% LTeX: dictionary+=SAMs
% LTeX: dictionary+=Signaal
% LTeX: dictionary+=Skyguard
% LTeX: dictionary+=Werrell
% LTeX: dictionary+=Brassey
% LTeX: dictionary+=Feuerleitgerät
% LTeX: dictionary+=Flt
% LTeX: dictionary+=Gt
...
\begin{withcounters}
    ...
    \subsectionwithtwocounters{towed FCR-A platoon}{mobile FCR-A platoon}{Towed and Mobile FCR-A Platoon}
...
\begin{withcounters}
    ...
    \subsectionwithtwocounters{towed FCR-B platoon}{mobile FCR-B platoon}{Towed and Mobile FCR-B Platoon}
...
It is used to control batteries of S-60 57~mm and KS-30 130~mm guns and entered service in the 1960s.%
\note{SON-50}{
...
\begin{withcounters}
    ...
    \subsectionwithtwocounters{towed FCR-C platoon}{mobile FCR-C platoon}{Towed and Mobile FCR-C Platoon}
...
It was used by Israel in the 1967 Six Day War and afterward, controlling batteries of Bofors 40~mm L/70 guns in the defense of strategic sites.
The Super Fledermaus also saw combat with the Argentine Air Force in the 1982 South Atlantic War controlling Oerlikon GDF guns in the defense of BAM Malvinas (Port Stanley Airport).%
...
\note{Flycatcher}{
    ...
    According to Wikipedia, the search radar is NATO I/J band and the tracking radar is NATO K band. RadarTutorial states the search frequency is 9.2 GHz (NATO I band) and the tracking frequency is either I or K band.
    Van Elk states the tracking radar is an independent pulse-Doppler 26.5--31 GHz (old-NATO Ka band) system, but this seems to be referring to an upgrade in 1992. He also mentions that the radar is used in the Goalkeeper CIWS, which Wikipedia states searches in I band and tracks in both I and K bands.
    I conclude:
    \begin{itemize}
    ...
    % LTeX: rules-=UPPERCASE_SENTENCE_START
    \begin{notesources}
...
\begin{withcounters}
    ...
    \subsectionwithtwocounters{towed FCR-D platoon}{mobile FCR-D platoon}{Towed and Mobile FCR-D Platoon}
...
\begin{table}
    \tablecaption{table:fcr-units}{FCR Unit Table}
    \centering
    \footnotesize
