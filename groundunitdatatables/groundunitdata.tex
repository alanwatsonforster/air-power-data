...
medium,\textnote{Medium Tanks}{
    ...
    \begin{itemize}
        ...
        \item Type 15: Wikipedia gives little information on the armor, but the weight is 36 tonnes (with the armor package), and that seems to corresponds more to a medium tank.
...
light,\textnote{Light Tanks}{
    ...
    \begin{itemize}
        \item The WRG 1950--1985 rules give class II and III (i.e., light) protection to the:
            ...
            Scimitar, and
            Scorpion
        \item M1128 Stryker MGS: With additional ceramic armor, this has protection against 14.5~mm but not heavier rounds, which I believe counts as III.
...
Reconnaissance vehicles are always light.\textnote{Light  Reconnaissance Vehicles}{
    Regarding the protection class:
    \begin{itemize}
        \item The WRG 1950--1985 rules give class II or III (i.e., light) protection to the:
            BRDM-2,
...
IFVs can be medium\textnote{Medium IFVs}{
    ...
    \begin{itemize}
        ...
        \item Boxer: Wikpedia states that with the baseline armor it is protected against medium-caliber rounds. Additional armor is also available.
        \item CV90: Wikipedia states that the CV90 has frontal protection against 30~mm APFSDS rounds. This is considerably more than typical light AFVs.
...
or light.\textnote{Light IFVs}{
    ...
    \begin{itemize}
        ...
        \item M1295 Dragoon: This is derived from the Stryker (light).
        ...
        \item Type 92: Wikpedia states that it is protected against small-arms rounds and the frontal armor can stop 12.7 mm rounds at 100 meters and 25 mm rounds at 1000 meters. This seems to correspond to light armor. The weight is also 21 tonnes, which is considerable less than most medium IFVs.
        ...
        \item Type 08: Wikpedia states that it is protected against small-arms rounds and the frontal armor can stop 12.7 mm rounds at 200 meter. This corresponds to light armor.
    \end{itemize}
...
light,\textnote{Light APCs}{
    ...
    \begin{itemize}
        ...
        \item Saxon: Wikpedia states that it is protected against small-arms rounds.
        \item TPz Fuchs: Wikpedia states that it is protected against small-arms rounds.
        \item Type 63: Wikpedia states that it is protected against small-arms rounds.
        \item Type 77: Wikpedia states that it is based on the PT-76 (light), and its weight of 15-5 tonnes matches other light APCs.
        \item Type 89: Wikpedia states that it is protected against small-arms rounds.
        \item Type 08: Based on Type 08 IFV (light).
    \end{itemize}
...
They include platoons with the 81-mm AMX-10P TMC-81, 81-mm FV432, 107-mm M106, 81-mm M125, 120-mm M1064, 120-mm M1129/M1252, and 120-mm VTM 120.

\paragraph{Towed Mortar Platoon} These have mortars on unprotected, towed mounts. They include platoons with the 120-mm M1938, 120-mm M1943, and 160-mm M-160. Smaller infantry mortars are found in infantry mortar platoons.

\paragraph{Armored Artillery Battery} These have guns or howitzers in armored vehicles that provide both mobility and protection for their crew and weapons from small arms and artillery shrapnel. They include batteries with the 130-mm 2S1 Gvozdika, 152-mm 2S3 Akatsiya, 152-mm 2S19 Msta-S, 105-mm Abbot, 155-mm AMX-30 AuF1, 155-mm AS-90, 155-mm M109, and 155-mm Panzerhaubitze 2000.

\paragraph{Tracked Artillery Battery}
These have guns or howitzers mounted on tracked vehicles that provide mobility, but do not provide protection from small arms or artillery shrapnel.
They include batteries with the 240-mm 2S4 Tyulpan, 203-mm 2S7 Pion, 105-mm M7 Priest, 175-mm M107, and 203-mm M110.

\paragraph{Mobile Artillery Battery}
These have guns or howitzers mounted on wheeled vehicles that provide limited mobility, but do not provide protection from small arms or artillery shrapnel.
They include batteries with the 155-mm Archer and 155-mm CAESAR.

\paragraph{Towed Artillery Battery} These have guns or howitzers in unprotected, towed mounts. They include batteries with the 152-mm D-20, 130-mm D-30, 122-mm D-74, 155-mm FH70, 105-mm L118 Light Gun, 155-mm M114, 105-mm M119, 155-mm M198, 105-mm OTO Melara Mod 56, and 87.6-mm QF 25-pounder. A truck platoon may transport a towed artillery battery.

\paragraph{Armored Rocket Artillery Battery} These are rocket-armed equivalents of armored artillery batteries. They include batteries with the M270 MLRS and TOS-1.

\paragraph{Mobile Rocket Artillery Battery} These are rocket-armed equivalents of mobile artillery batteries. They include batteries with the BM-21 Grad, BM-30 Smerch, and M142 HIMARS.

\paragraph{Tracked Missile Artillery Battery} These are missile-armed equivalents of tracked artillery batteries. They include batteries with the MGM-52 Lance and Pluton.

\paragraph{Mobile Missile Artillery Battery} These are missile-armed equivalents of mobile artillery batteries. They include batteries with the 9K52 Luna-M (Frog), Corporal, Sergeant, M34/M50 Honest John, M74 Redstone, M790 Pershing 1a, M1003 Pershing II, OTR-21 Tochka (SS-21), and RSD-10 Pioneer (SS-20).\textnote
...
These are platoons with tracked carrier vehicles from Table~\ref{table:vehicle-types}.\textnote{Tracked Carrier Vehicles IFVs}{
    All of the listed tracked carriers are stated as being unarmored by Wikipedia.
}
