...
Conventional gun-armed anti-tank vehicles are considered to be tanks.\textnote{Anti-Tank Units}{
...
Reconnaissance vehicles are armored vehicles specialized in scounting and observation and with no significant offensive weapons.
...
These are platoons with open IFVs from Table~\ref{table:vehicle-types}.\textnote{Open IFVs}{
    Regarding the protection class:
    \begin{itemize}
        \item The WRG 1950--1985 rules give class I (i.e., open) protection to the:
            BTR-40,
