...
APCs can be heavy\textnote{Heavy APC}{
    Regarding the protection class:
    \begin{itemize}
...
It is commonly used with 57~mm S-60, 85~mm KS-12, 100~mm KS-19, and 130~mm KS-30 batteries.\textnote{SON-9}{
...
The Contraves Super Fledermaus FCR-C can be used to control a section of two Oerlikon GDF 35~mm guns; it cannot control a whole battery.\textnote{Super Fledermaus}{
...
\begin{itemize}
    ...
    \item Tables~\ref{table:ob-soviet-tank-battalion-1980s},
        ...
        A Soviet front-line motor-rifle division from the 1980s with its constituent regiments and battalions.\textnote{Soviet Units}{These are from US Army FM 100-2-3 from 1991.}
