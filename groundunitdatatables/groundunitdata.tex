...
The units described here are generic, but the \hyperlink{table:vehicle-types}{Vehicle Types Table} gives the correspondence between specific vehicles and these generic vehicle types.
...
\subsectionwithcounter{Tank Platoon}{\fourcounters{heavy tank platoon}{medium tank platoon}{light tank platoon}{open tank platoon}}{
    ...
    \example[Heavy examples]{M1 Abrams and T-64/72/80.}

    \example[Medium examples]{M60 and T-54/55/62.}

    \example[Light examples]{M551 Sheridan and PT-76.}
...
\subsectionwithcounter{IFV Platoon}{\twocounters{medium IFV platoon}{light IFV platoon}}{
    ...
    \example[Medium example]{M2A2 Bradley.}

    \example[Light examples]{M2/M2A1 Bradley and BMP-1/2.}
}
...
\subsectionwithcounter{APC Platoon}{\fourcounters{heavy APC platoon}{medium APC platoon}{light APC platoon}{open APC platoon}}{
    ...
    \example[Light examples]{M113 and BTR-50PK/60PB/70.}
...
\subsectionwithcounter{Armored Anti-Tank Missile Platoon}{\twocounters{medium armored anti-tank missile platoon}{light armored anti-tank missile platoon}}{
    ...
    Conventional gun-armed tank destroyers are considered to be tanks.
    ...
    \example[Medium example]{Rakaten Jpz.}

    \example[Light examples]{M901 and BRDM.}
}
...
\subsectionwithcounter{Armored Reconnaissance Platoon}{\twocounters{light armored reconnaissance platoon}{open armored reconnaissance platoon}}{
    ...
    \example[Light examples]{M114 and BRDM-2.}
...
Unarmored or soft vehicles provide mobility, but do not provide armor protection (or provide only incomplete armor protection) for their crew and weapons.
The units described here are generic, but the \hyperlink{table:vehicle-types}{Vehicle Types Table} gives the correspondence between specific vehicles and these generic vehicle types.
...
\subsectionwithcounter{Light Truck Platoon}{\counter{light truck platoon}}{
    ...
    \example[Examples]{M151 Jeep, HMMWV, and GAZ-69.}
}
