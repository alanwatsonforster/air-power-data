...
\emph{Assault} is a tactical level simulation of ground combat in Europe in the mid-1980's As modern tactical combat is a subject of extreme breadth, \emph{Assault} comprises the first in a series of games. Complete by itself, \emph{Assault} covers mobile engagements between U.S. and Soviet tank and mechanized forces. Other games and modules add helicopters, engineering, combat in built-up areas, tactical air strikes, and other belligerents.
...
AFVs have heavy, medium, light, or open armor protection.
...
Table~\ref{table:vehicle-types} gives an extensive but not exhaustive list of vehicle types. It should serve as guidance for other vehicles.

\subsection{Infantry Units}

Infantry are soldiers trained to fight on foot.
In some cases, they are also trained to fight from IFVs.
...
\leftcounter{counters/infantry platoon.png}

Infantry platoons are armed principally with small arms, often supplemented with light machine guns and sometimes with light grenade launchers and portable anti-tank weapons such as bazookas, LAWs, MAWs, and portable ATGMs. They are the primary combat units in larger infantry formations.

\paragraph{Infantry Weapons Platoon}

\leftcounter{counters/infantry weapons platoon.png}

These are equipped with a mix of heavier weapons, such as medium or heavy machine guns, recoilless rifles, portable ATGMs, and automatic grenade launchers.
They are often battalion-level assets, and their role is to provide longer-range direct-fire support to the associated infantry units.
...
\leftcounter{counters/infantry mortar platoon.png}

These are equipped with somewhat portable 60-mm, 81-mm, 82-mm, or similar mortars.
They are often battalion-level assets, and their role is to provide indirect fire support and smokescreens for associated infantry units.
Due to the weight of ammunition required for sustained fire, an infantry mortar platoon will often be transported by a light truck platoon even if the other infantry units in its formation do not have transport.

\paragraph{Infantry FAQ Squad}
\leftcounter{counters/infantry FAC squad.png}
...
\paragraph{Infantry SAM and Infantry Heavy SAM Squads}
\leftdoublecounter{counters/infantry SAM squad.png}{counters/infantry heavy SAM squad.png}
...
\leftquadruplecounter{counters/heavy tank platoon.png}{counters/medium tank platoon.png}{counters/light tank platoon.png}{counters/open tank platoon.png}
...
\paragraph{Anti-Tank Missile Platoon}
\leftdoublecounter{counters/medium anti-tank platoon.png}{counters/light anti-tank platoon.png}

Anti-tank missile vehicles are armored vehicles equipped with anti-tank guided missiles which mission is the destruction of other armored vehicles.
...
Anti-tank vehicles may be medium\note{Medium Anti-Tank Vehicles}{
    Regarding the protection class:
    \begin{itemize}
...
It is often a battalion or regimental asset.
Examples are given in Table~\ref{table:vehicle-types}.

\paragraph{Towed Anti-Tank Gun Battery}
\leftcounter{counters/towed anti-tank battery.png}

These have anti-tank guns in towed mounts with only very limited protection.
A truck, tracked carrier, or APC platoon may transport a towed anti-tank battery.
It is often a regimental or divisional asset.
...
Reconnaissance vehicles may be light\note{Light  Reconnaissance Vehicles}{
    Regarding the protection class:
    \begin{itemize}
        \item The WRG 1950--1985 rules give class II or III (i.e., light) protection to the:
            BRDM-2,
...
Some IFVs are also designed to allow their attached infantry to fight while mounted.%
\note{IFV and APC Units}{
...
Normal platoons serve as the HQ platoons of companies.%
\note{HQ Units}{
...
Armored artillery vehicles have light\note{Light Armored Artillery}{
    Regarding the protection class:
    \begin{itemize}
...
These have guns or howitzers mounted on tracked vehicles that provide mobility, but do not give at most limited protection from small arms or artillery shrapnel.\note{Tracked Artillery}{
    Regarding the protection class:
    \begin{itemize}
        \item The WRG 1950--1985 rules give class I (i.e., open) protection to the
            AMX.155F3 (AMX-13 F3),
...
These have howitzers mounted on wheeled vehicles that provide mobility, but give at most limited protection from small arms or artillery shrapnel.\note{Mobile Artillery}{
    Regarding the protection class:
    \begin{itemize}
...
Armored rocket artillery vehicles have light\note{Light Armored Artillery}{
    Regarding the protection class:
    \begin{itemize}
...
Examples are given in Table~\ref{table:vehicle-types}.%
\note{Missile Artillery Batteries}{
...
These are platoons with tracked carrier vehicles from Table~\ref{table:vehicle-types}.\note{Tracked Carrier Vehicles IFVs}{
...
A ground unit will have a type, for example, “heavy tank” or “ZSU-23-4”, and a size, which will be one of squad, section, platoon, or battery according to its number of soldiers, vehicles, guns, or launchers.
...
\ruleparagraph{Larger Units}

Companies, battalions, and other larger units above platoons or batteries are represented by multiple units. For example, an infantry company might be formed by three infantry platoons.

\ruleparagraph{Squads and Sections}

Most of the ground units described here and employed in the game are platoons or batteries, but all ground combat and transport platoons are also available as sections and squads and all AAA platoons and batteries are also available as sections.
...
\ruleparagraph{Other Terms}

In the game, ground units are uniformly referred to as squads, sections, platoons, and batteries. However, other terms are used for units even within English-speaking armies. For example, in the US Armored Cavalry, a troop is equivalent to a company and a squadron is equivalent to a battalion, but in the British Army and many Commonwealth armies, a troop is equivalent to a platoon and a squadron is the equivalent of a company.
% Sometimes a regiment is equivalent to a battalion and other times to a brigade.

\rulesubsection{Basic Properties}

The type and size of a ground unit determines its basic properties. These describe its visibility to aircraft, vulnerability to air-to-ground and ground-to-ground attacks,  capacity for ground-to-ground attacks, ability to move through difficult terrain, and value in VPs.
...
\ruleparagraph{Damage Resilience}

A ground unit has a damage resilience, which is the amount of damage it can suffer before being killed. It is determined by the size of the unit: a squad has a damage resilience of 1D; a section has a damage resilience of 2D; and a platoon or battery has a damage resilience of 3D.%
...
\ruleparagraph{Defense Strength and Target Class}

A ground unit has a numerical defense strength, which is used to calculate the odds for air-to-ground attacks and for ground-to-ground combat, and a target class, which is used to select the appropriate attack strengths of any weapons used in air-to-ground attacks.
The target class can be a hard, open, or soft target according to the degree to which it provides armored protection to its personnel and weapons.

A hard target has armored protection from both direct and top attacks and is denoted by an underlined defense strength.
...
An open target has armored protection from direct attacks but not from top attacks and is denoted by an underlined defense strength followed by an exclamation point.
It is normally treated as a hard target, but against napalm, fire, FAE, and air-burst HE bombs, it is considered to be a soft target. %
\note{Open Targets}{
...
A soft target does not have armored protection their personnel and/or weapons and does not have an underlined defense strength. %
\note{Soft Targets}{
    Examples of soft targets iinclude infantry, towed artillery, unarmored vehicles, and armored vehicles that do not fully protect their personnel and/or weapons such as the M-107 and M-110 tracked artillery vehicles.
