...
\subsectionwithcounter{Infantry Platoon}{\counter{infantry platoon}}{
    An infantry platoon is armed principally with small arms, often supplemented with light machine guns and sometimes with light grenade launchers and portable anti-tank weapons such as bazookas, LAWs, MAWs, and portable ATGMs. It is the primary combat unit in larger infantry formations.
}

\subsectionwithcounter{Infantry Weapons Platoon}{\counter{infantry weapons platoon}}{
...
\subsectionwithcounter{Infantry Mortar Platoon}{\counter{infantry mortar platoon}}{
    An infantry mortar platoon is equipped with 60-mm, 81-mm, 82-mm, or similar mortars.
    It is are often battalion-level assets, and its role is to provide indirect fire support and smokescreens to the infantry platoons in its formation.
...
\subsectionwithcounter{Infantry FAQ Squad}{\counter{infantry FAC squad}}{
...
\subsectionwithcounter{Infantry SAM Squad}{\counter{infantry SAM squad}}{
...
\subsectionwithcounter{Infantry Heavy SAM Squad}{\counter{infantry heavy SAM squad}}{
...
\subsectionwithcounter{Infantry HQ Platoon}{\counter{infantry HQ platoon}}{
    ...
    \note{Infantry HQs}{
        In the \emph{Air Strike} scenarios HQ platoons are included at a ratio of about one to every nine normal platoons, so they seem to be battalion HQs.
    }
}
...
Armored cars and armored half-tracks are considered to be light tanks, light anti-tank missile vehicles, light reconnaissance vehicles, light IFVs, or light or open APCs according to their role and armament.
...
\subsectionwithcounter{Tank Platoon}{\fourcounters{heavy tank platoon}{medium tank platoon}{light tank platoon}{open tank platoon}}{
    A tank platoon has armored vehicles principally armed with a direct-fire gun.
    The gun is most commonly mounted in a turret, but AFVs with casemate guns are also considered to be tanks.
    Its role is the support of infantry and the destruction of other tanks and armored vehicles.
    A tank platoon may have heavy, medium, light, or open armor.
    \note{Tanks}{
        \noteparagraph{Protection Levels}
        My basic source for protection levels for tanks and other AFVs is the Wargames Research Group (WRG) 1950--1985 miniatures rules. These give armor classes of I to X for a range of AFVs. Comparing to the scenarios in {\AirStr} and {\EOTG}, the correspondence seems to be:
        \begin{itemize}
    ...
    \example[Heavy examples]{M1 Abrams, Chieftain, Challenger, Leopard 2, and T-64/72/80.}

    \example[Medium examples]{M60, Centurion, Leopard 1, and T-54/55/62.}
...
\subsectionwithcounter{IFV Platoon}{\twocounters{medium IFV platoon}{light IFV platoon}}{
    ...
    \example[Medium example]{M2A2 Bradley and Marder.}

    \example[Light examples]{M2/M2A1 Bradley, FV432 RARDEN, Warrior, and BMP-1/2.}
}

\subsectionwithcounter{APC Platoon}{\fourcounters{heavy APC platoon}{medium APC platoon}{light APC platoon}{open APC platoon}}{
    ...
    \example[Heavy examples]{Nakpadon.}

    \example[Medium examples]{Nagmashot and Nagmachon.}
...
\subsectionwithcounter{Armored Anti-Tank Missile Platoon}{\twocounters{medium armored anti-tank missile platoon}{light armored anti-tank missile platoon}}{
    ...
    It is often a battalion- or regiment-level asset.
    An anti-tank platoon may have medium or light armor.%
    \note{Anti-Tank Missile Vehicles}{
...
\subsectionwithcounter{Armored Reconnaissance Platoon}{\twocounters{light armored reconnaissance platoon}{open armored reconnaissance platoon}}{
...
\subsectionwithcounter{Armored Mortar Platoon}{\counter{light armored mortar platoon}}{
...
\subsectionwithcounter{Armored Artillery Battery}{\twocounters{light armored artillery battery}{open armored artillery battery}}{
    ...
    \example[Examples]{M109, 2S3, and 2S1.}
}

\subsectionwithcounter{Armored Rocket Artillery Battery}{\counter{light armored rocket artillery battery}}{
...
\subsectionwithcounter{Armored HQ Platoon}{\counter{light armored HQ platoon}}{
...
\subsectionwithcounter{Truck Platoon}{\counter{truck platoon}}{
...
\subsectionwithcounter{Light Truck Platoon}{\counter{light truck platoon}}{
    ...
    \example[Examples]{M151 Jeep, HMMWV, Landrover, Ilitis, and GAZ-69.}
}

\subsectionwithcounter{Tracked Carrier Platoon}{\counter{tracked carrier platoon}}{
...
\subsectionwithcounter{Mobile Anti-Tank Missile Platoon}{\counter{mobile anti-tank missile platoon}}{
    A mobile anti-tank missile platoon is equipped with anti-tank missiles mounted on unarmored light trucks.

    \example[Examples]{M151 TOW and M966 HMMWV TOW.}
}

\subsectionwithcounter{Tracked Artillery Battery}{\counter{tracked artillery battery}}{
...
\subsectionwithcounter{Mobile Artillery Battery}{\counter{mobile artillery battery}}{
...
\subsectionwithcounter{Mobile Rocket Artillery Battery}{\counter{mobile rocket artillery battery}}{
...
\subsectionwithcounter{Tracked Missile Artillery Battery}{\counter{tracked missile artillery battery}}{
...
\subsectionwithcounter{Mobile Missile Artillery Battery}{\counter{mobile missile artillery battery}}{
...
\subsectionwithcounter{Mobile HQ Platoon}{\counter{mobile HQ platoon}}{
...
\subsectionwithcounter{Towed Anti-Tank Gun Battery}{\counter{towed anti-tank gun battery}}{
...
\subsectionwithcounter{Towed Mortar Platoon}{\counter{towed mortar platoon}}{
...
\subsectionwithcounter{Towed Artillery Battery}{\counter{towed artillery battery}}{
    A towed artillery battery has guns or howitzers on towed mounts with at most only very limited protection.
    It is often a regimental-, brigade-, or divisional-level asset.

    \example[Examples]{M119, M198, and 2A18 (D-30).}
}
...
All AAA platoons and batteries are also available as sections (but not squads), with damage resiliences of 2, hit rolls reduced by 1, and VPs corresponding to a platoon or battery that has taken 1D damge.
...
\subsectionwithcounter{Mobile ZPU-1/2/4 Section}{\threecounters{mobile ZPU-1 section}{mobile ZPU-2 section}{mobile ZPU-4 section}}{
    ...
    \note{Mobile ZPU-1 and ZPU-2 Section}{
...
The Contraves Super Fledermaus FCR-C can be used to control a section of two Oerlikon GDF 35~mm guns; it cannot control a whole battery.\note{Super Fledermaus}{
