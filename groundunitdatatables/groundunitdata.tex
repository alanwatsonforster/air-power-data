...
\subsection{Tank Units}

Tanks are armored vehicles that are specialized for direct fire with a gun.
Here, the gun does not have to be mounted in a turret; AFVs with casemate guns such as the SU-100, Kanonenjagdpanzer, and Stridsvagn 103 are also considered to be tanks.
Tanks are distinguished by their level of armor protection.\textnote
{Light, Medium, and Heavy Armor}{
    The protection level of tanks and other AFVs are based on the armor classes in the Wargames Research Group 1950--1985 rules: open is class I; light is class II to III; and heavy is class IX and X.
...
These are platoons with heavy tanks from Table~\ref{table:vehicle-types}.\textnote{Heavy Tanks}{
    ...
    \begin{itemize}
        \item The WRG 1950--1985 rules give class IX or X (i.e., heavy) protection to the:
            ...
            T-72, and
            T-80.
        \item Al-Kalid/VT-1A and Type 99: These are based on the Type 90-II prototype, which in turn is based on the T-72.
        \item Challenger 2: This is derived from the Challenger~1.
        \item IS-2: This has a similar weight to the IS-3 (both 46 tonnes) and a similar armament (122 mm D-25), so presumably similar protection.
        \item K1: This is derived from the M1.
        \item M-84, PT-91, and T-90: These are derived from the T-72.
        \item Merkava 2/3/4: These are derived from the Merkava~1.
        \item T-84. This is derived from the T-80.
    \end{itemize}
...
These are platoons with medium tanks from Table~\ref{table:vehicle-types}.\textnote{Medium Tanks}{
    Regarding the protection class:
    \begin{itemize}
        \item The WRG 1950--1985 rules give class IV to IIX (i.e., medium) protection to the:
            ...
            Type 74, and
            Vijayanta.
        \item M26: The M46 is largely an M26 with an improved engine.
        \item M-50 and M-51 Sherman: These are based on the M4 and have improved armament and engines.
        \item Panzer 61: This is essentially an early version of the Panzer 68.
        \item Type 59/69/79: The Type 59 was Chinese version of the T-54A. The Type 69 and 79 had improved equipment, some of which was derived from captured T-62s, but the same level of protection.
        ...
        \item Vickers MBT: The Vijayanta is very similar to this.
    \end{itemize}
}

\paragraph{Light Tank Platoon}

These are platoons with medium tanks from Table~\ref{table:vehicle-types}.\textnote{Light Tanks}{
    Regarding the protection class:
    \begin{itemize}
...
These are platoons with open tanks from Table~\ref{table:vehicle-types}.\textnote{Open Tanks}{
...
\subsection{Anti-Tank Units}

Anti-tank vehicles are armored vehicles equipped with ATGMs.
Conventional gun-armed anti-tank vehicles are considered to be tanks.
Anti-tank vehicles are distinguished by their level of armor protection.\textnote
{Anti-Tank Units}{
...
These are platoons with medium anti-tank vehicles from Table~\ref{table:vehicle-types}.\textnote{Medium  Anti-Tank Vehicles}{
Regarding the protection class:
\begin{itemize}
...
These are platoons with light anti-tank vehicles from Table~\ref{table:vehicle-types}.\textnote{Light  Anti-Tank Vehicles}{
Regarding the protection class:
\begin{itemize}
...
However, IFVs provide fire support and typically have a 20~mm or larger cannon, and APCs do not.
...
They are further distinguished by their level of armor protection.
A mechanized infantry platoon will normally be transported by a platoon of APCs or IFVs.

\paragraph{Medium IFV Platoon}

These are platoons with medium IFVs from Table~\ref{table:vehicle-types}.\textnote{Medium IFVs}{
...
These are platoons with light IFVs from Table~\ref{table:vehicle-types}.\textnote{Light IFVs}{
...
An armored HQ platoon is the HQ unit of a tank, mechanized infantry, or armored artillery battalion or regiment. It is equipped with lightly armored vehicles such as the AIFV-B-CP, BMP-1K, BMT-2K, BTR-60P/PA/PB/PBK, FV105 Sultan, M577, M1068, M1130, YPR-765 PRCO-C, or adapted APCs.
...
\item A hard target has armored protection both from side and top attacks and is denoted by an underlined defense strength. It is classified as heavy, medium, or light according to its degree of protection, but this classification is simply descriptive. Most tanks, IFVs, and APCs are hard targets.\textnote
    {Hard Targets}{
...
\item A soft target does not have armored protection and does not have an underlined defense strength. Examples include infantry, towed artillery, unarmored vehicles, and armored vehicles that do not fully protect their personnel and weapons such as the M-107 and M-110 tracked artillery vehicles.\textnote
    {Soft Targets}{
        Nothing like the M-107/110 is included in \emph{Air Strike}, but again I would assert that it is tracked mainly for mobility. Effectively, these are towed artillery installed in an exposed position on a tracked hull and have almost no protection for most of the crew.
    }
