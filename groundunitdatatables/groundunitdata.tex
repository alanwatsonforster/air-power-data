...
Tanks are distinguished by their level of protection.%
\note{
...
These include platoons with the ASU-57 or SU-76.%
\note{
...
\paragraph{Mobile Missile Artillery Battery.} These are missile-armed equivalents of mobile artillery batteries. They include batteries with the 9K52 Luna-M (Frog), Corporal, Sergeant, M34/M50 Honest John, M74 Redstone, M790 Pershing 1a, M1003 Pershing II, OTR-21 Tochka (SS-21), and RSD-10 Pioneer (SS-20).%
\note{
...
An armored HQ platoon represents the HQ unit of a tank or mechanized infantry battalion or regiment. It is equipped with lightly armored vehicles such as the AIFV-B-CP, BMP-1K, BMT-2K, BTR-60P/PA/PB/PBK, FV105 Sultan, M577, M1068, M1130, YPR-765 PRCO-C, or adapted APCs.%
...
\note{
    For the Oerlikon GDF battery: The AAA values for the battery are from \emph{Air Strike} with the hit rolls reduced from 5/4/3 to 4/3/2 as described in the extended note above.
}
...
\begin{itemize}
    ...
    \item Table~\ref{table:ob-twelth-infantry}: 12th Infantry Regiment at the 1982 Battle of Goose Green, with attachments from the 25th Infantry Regiment, 4th Airborne Artillery Regiment, 601st Anti-Aircraft Artillery Group.RA, and a Recce Troop of 59 Independent Commando Squadron, RE.

    \item Table~\ref{table:ob-british-armored-regiment-1960}: An armored regiment (battalion) of the British Army from about 1960.%
        \note{
            This is from the document “Modern British TOEs” by Richard A. Rinaldi (2002).
        }
\end{itemize}
...
\begin{table*}[p]
    ...
    \label{table:ob-british-armored-regiment-early-1960}
    \small
    \begin{tabularx}{0.9\linewidth}{LLL}
        \toprule
        Element&Game Ground Unit&Notes\\
        ...
        &\binarymultiply{3}{light tank platoon}&Ferret/Saladin\\

        A Tank Squadron
        &\binarymultiply{3}{medium tank platoon}&Centurion\\
        &\binarymultiply{1}{heavy tank platoon}&Conqueror\\
...
\begin{table*}[p]
    ...
    \label{table:ob-british-apc-infantry-battalion-early-1960}
    \small
    \begin{tabularx}{0.9\linewidth}{LLL}
        \toprule
        Element&Game Ground Unit&Notes\\
        ...
        &\binarymultiply{3}{infantry platoon}&\\
        &\binarymultiply{1}{infantry weapons platoon}&\\
        &\binarymultiply{4}{light APC platoon}&Saracen/FV432\\
...
\begin{table*}[p]
    ...
    \begin{tabularx}{0.9\linewidth}{LLL}
        ...
        A Battery
        &\binarymultiply{1}{tracked artillery battery}&Cardinal (M44)\\
...
\begin{table*}[p]
    ...
    \begin{tabularx}{0.9\linewidth}{LLL}
        ...
        &\binarymultiply{2}{light tank platoon}&Scorpion\\

        ATGW Troop
        &\binarymultiply{3}{light anti-tank platoon}&FV438\\

        A Tank Squadron
        &\binarymultiply{4}{heavy tank platoon}&Chieftain\\
