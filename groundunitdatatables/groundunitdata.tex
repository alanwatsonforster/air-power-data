...
Reconnaissance vehicles are armored vehicles specialized in scouting and observation and with no significant offensive weapons.
...
\paragraph{Heavy Tank Platoon}

These have heavy tanks such as those from Table~\ref{table:vehicle-types}.\textnote{Heavy Tanks}{
...
\paragraph{Medium Tank Platoon}

These have medium tanks such as those from Table~\ref{table:vehicle-types}.\textnote{Medium Tanks}{
    Regarding the protection class:
    \begin{itemize}
...
\paragraph{Light Tank Platoon}

These have light tanks such as those from Table~\ref{table:vehicle-types}.\textnote{Light Tanks}{
    Regarding the protection class:
    \begin{itemize}
...
\paragraph{Open Tank Platoon}

These have open tanks such as those from Table~\ref{table:vehicle-types}.\textnote{Open Tanks}{
...
\paragraph{Medium Anti-Tank Platoon}

These have medium anti-tank vehicles such as those from Table~\ref{table:vehicle-types}.\textnote{Medium  Anti-Tank Vehicles}{
    Regarding the protection class:
    \begin{itemize}
...
\paragraph{Light Anti-Tank Platoon}

These have light anti-tank vehicles such as those from Table~\ref{table:vehicle-types}.\textnote{Light  Anti-Tank Vehicles}{
    Regarding the protection class:
    \begin{itemize}
...
\paragraph{Light Reconnaissance Platoon}

These have light reconnaissance vehicles such as those from Table~\ref{table:vehicle-types}.\textnote{Light  Reconnaissance Vehicles}{
    Regarding the protection class:
    \begin{itemize}
        \item The WRG 1950--1985 rules give class II or III (i.e., light) protection to the:
            BRDM-2,
...
\paragraph{Medium IFV Platoon}

These have medium IFVs such as those from Table~\ref{table:vehicle-types}.\textnote{Medium IFVs}{
    Regarding the protection class:
    \begin{itemize}
        \item The WRG 1950--1985 rules give class IV (i.e., medium) protection to the:
            Marder.
...
\paragraph{Light IFV Platoon}

These have light IFVs such as those from Table~\ref{table:vehicle-types}.\textnote{Light IFVs}{
    Regarding the protection class:
    \begin{itemize}
        \item The WRG 1950--1985 rules give class II or III (i.e., light) protection to the:
            AMX-10P,
...
\paragraph{Medium APC Platoon}

These have medium APCs such as those from Table~\ref{table:vehicle-types}.\textnote{Medium APCs}{
    Regarding the protection class:
    \begin{itemize}
        \item Boxer: Wikpedia states that with the baseline armor it is protected against medium-caliber rounds. Additional armor is also available.
    \end{itemize}
}
\paragraph{Light APC Platoon}

These have light APCs such as those from Table~\ref{table:vehicle-types}.\textnote{Light APCs}{
    Regarding the protection class:
    \begin{itemize}
        \item The WRG 1950--1985 rules give class II or III (i.e., light) protection to the:
            BTR-50PK,
...
\paragraph{Open APC Platoon}

These are platoons with open APCs from Table~\ref{table:vehicle-types}.\textnote{Open IFVs}{
    Regarding the protection class:
    \begin{itemize}
        \item The WRG 1950--1985 rules give class I (i.e., open) protection to the:
            BTR-40,
...
An armored HQ platoon is the HQ unit of a tank, mechanized infantry, or armored artillery battalion or regiment. It is typicallu equipped with modified APCs such as the AIFV-B-CP, BMP-1K, BMT-2K, BTR-60P/PA/PB/PBK, FV105 Sultan, M577, M1068, M1130, YP-408 PWCO, and YPR-765 PRCO-C.
