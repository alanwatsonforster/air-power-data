...
FCR-As typically use 1940s technology. They include the SCR-584 and SON-9 FCRs.
...
\note{Flycatcher}{
    ...
    According to Wikipedia, the search radar is I/J band (ITU SHF) and the tracking radar is K band (ITU SHF/EHF).

    \begin{notesources}
        \item Wikipedia on the \href{https://en.wikipedia.org/wiki/Flycatcher_(radar)}{Flycatcher}.
        \item \href{https://magazines.defensie.nl/materieelgezien/2020/09/06_flycatche}{Terug naar de toekomst: De Flycatcher}.
    \end{notesources}
}
