...
\orderofbattle{Task Force Mercedes}{goose-green-12-infantry-regiment}{
    The Argentine Army at Goose Green was called \emph{Fuerza de Tareas Mercédes} (Task Force Mercedes). It consisted of 12th Infantry Regiment, with three line companies A/B/C, and reinforced with C company of 25th Infantry Regiment, three 105~mm pack howitzers [one section] of A Battery of 4th Airborne Artillery Regiment, an engineers platoon from the 9th Engineering Company, two Oerlikon GDF 35~mm AA guns with a Skyguard FCR of B Battery of 601st Anti-Aircraft Artillery Group, and a pair of SA-7B squads.
}
