...
\orderofbattletext{
    The British Army in the early 1960s was in transition. It still operated with a mixture of medium Centurion tanks  (upgraded with the L7 105~mm gun) and heavy Conqueror tanks, and operated both mechanized and motorized infantry.%
...
\orderofbattle{Armoured Regiment}{british-armoured-regiment-early-1960s}{
    This regiment has three squadrons A/B/C each with three tank troops with Centurion medium tanks and one tank troop with Conqueror heavy tanks. The reconnaissance (R) squadron has three light reconnaissance troops with Ferret armored cars.
...
\orderofbattle{APC Infantry Battalion}{british-APC-infantry-battalion-early-1960s}{
    This battalion has three companies A/B/C each with three infantry platoons, one infantry weapons platoon, and corresponding light APC platoons with Saracen light APCs to provide mobility and protection.
}
...
\orderofbattle{Heavy Artillery Regiment}{british-heavy-artillery-regiment-early-1960s}{
    This regiment has four batteries A/B/C/D, of which A/B batteries each have two Honest John mobile missile launchers (and are represented by section) and C/D batteries each have four towed 8-inch M1 guns with trucks.
