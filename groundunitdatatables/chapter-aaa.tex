...
\subsectionwithcounter{Sinai 23 Section}{\twocounters{Sinai 23 Ayn-al-Saqr section}{Sinai 23 Stinger section}}{
    ...
    \note{Sinai 23 Section}{
        ...
        One issue here is that the Sinai 23 (with two barrels) then has the same hit rolls and damage rating as the ZSU-234 (with four barrels). Perhaps this is acceptable, since there are 30 years between these systems.
