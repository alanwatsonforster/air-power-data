...
\note{Sources}{
    ...
    \begin{itemize}\raggedright
        \item \href{https://commons.wikimedia.org/wiki/File:Royal_Australian_Air_Force,_on_loan_to_the_Temora_Aviation_Museum,_(VH-IPN,_former_military_registration_A94-983)_CAC_Sabre_Mk.32_landing_at_Avalon_during_the_2015_Australian_International_Airshow.jpg}{Bidgee} (CC BY-SA 3.0)
    \end{itemize}
...
\note{Mk.31}{ The ADC for the Mk.31 is adapted from Webster's in APJ 25.
}
...
\note{Mk.32}{ The ADC for the Mk.32 is adapted from Webster's in APJ 25.
...
\note{Guns}{Two 30 mm ADEN guns with 162 rounds per gun (Wikipedia). At 1200 rounds per minute, this is 4.0 shots.
}
...
\note{Four Fuel Tanks}{Farquhar comments on lack of improvement in range from adding two 100 gallon tanks in addition to two 167 tanks. In game terms, the aircraft is 1/2 with two tanks but DT with four tanks.
}
