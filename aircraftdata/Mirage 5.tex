...
The Mirage 5F was the original version built for Israel but eventually being used by France.\note{Mirage 5F}{The original ADC for the Mirage 5, presumably the 5F version, appeared in {\AirStr}. The service history of the 5F is from \href{https://en.wikipedia.org/wiki/Dassault_Mirage_5}{Wikipedia}.}
