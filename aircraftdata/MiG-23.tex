...
\note{MiG-23S Technical Data}{
    ...
    \noteparagraph{}and that armament options include R-3S IRM, R-13M IRM, R-3R RHM, RPs, BBs, cluster BBs, napalm BBs, and the Kh-23. Goebel does not mention the ability to carry a FT.

}

It is equipped with the R-27F-300 or R-27F2-300 engine and early wings with leading- and trailing-edge flaps for better take-off and landing performance. As the Soviet Union's first swing-wing combat aircraft, it represented a step-change in complexity for manufacturers, maintainers, and flight crew, and suffered from reliability and safety problems.
...
\note{Gun}{See Wikipedia on the MiG-23 and GSh-23.
    ...
    The fixed wing stations of the 23BN are described by Goebel and confirmed by the JBG-37 site. If they only carry an 800L FT, then the maximum weight on them will be 1,730 lb.
...
The initial MiG-23S has only four weapon stations, two under the fuselage and two under the wing gloves, and can carry 2,000~kg (4,400~lb) of external stores.%
\note{Loads and Stations}{
    Mladenov and Goebel state that MiG-23S can carry total load of 2,000~kg or 4,400~lb and has only the wing-glove and fuselage stations (not the centerline or wing stations).
}

\paragraph{Air-to-Air Weapons}
The MiG-23S, with its radar and fire-control system derived from the MiG-21S, can only carry R-3S and R-13M IRMs and R-3R RHMs.%
\note{Air-to-Air Weapons}{
    See Mladenov and Goebel.
}

\paragraph{Air-to-Ground Weapons}
The MiG-23S can carry BBs (HE, Napalm, and cluster), UB-16-57 (\binarymultiply{16}{57~mm}) RPs or S-24 (240 mm) RKs. It can also carry two Kh-23 (AS-7 Kerry) RGs. %
