...
As the Soviet Union's first swing-wing combat aircraft, the MiG-23S represented a step-change in complexity for manufacturers, maintainers, and flight crew, and suffered from reliability. The airframe suffered from cracks, which limited it to 4G, and could easily enter a spin at a high angle-of-attack.

Only about 60 MiG-23S were built. They entered service with VVS-FA in 1970, but were soon withdrawn.%
...
The MiG-23 is equipped with the Sapfir-23L radar, which is capable of guiding R-23R (AA-7 Apex) RHMs. However, while a great improvement on the Sapfir-21 radar of the MiG-21S, this version of the radar lacks the look-down/shoot-down capability of later versions.
It is also equipped with an IRST and HUD.

The changes in the airframe did not resolve the dangerous behavior at high angle-of-attack or doubts about the ability of the airframe to survive more than 4G.
...
The MiG-23M is equipped with the Safir-23D (High Lark II) radar (later upgraded to the Safir-23D-III), with a look-down/shoot-down capability. It also gained the capability to use R-60/60M (AA-8 Aphid) IRMs.

The MiG-23M entered service with the VVS-FA in 1973 and the IA PVO in the mid 1970s.%
\note{MiG-23M Service History}{
    See Mladenov, Goebel, and Wikipedia on the MiG-23M.
}

Manufacturing problems persisted, and until 1977 the MiG-23M was limited to 5G, which effectively prevented practicing dogfighting. In combat, this limit would of course have been ignored, but the pilots would have found themselves unaccustomed to the effects of high-G and more susceptible to GLIC; in the game this is reflected in a \minus{1} modifier for GLOC rolls.
...
The MiG-23MF comes in two major variants. The Warsaw Pact variant is almost identical to the MiG-23M. The Third World variant had degraded ECCM for the radar and other avionics, and was only supplied with the R-80 (AA-8 Aphid) IRM from 1981. Both have airframes and engines that are identical to the MiG-23M.%
\note{MiG-23MF ADC and Technical Data}{
    ...
    \noteparagraph{Third World Variant} The Third World variant has degraded radar ECM/ECCM (which I take to be a radar ECCM of 0, RWR-A instead of B, and no AJM), no datalink, and the R-60 only from 1981. The degraded ECM/ECCM is largely taken from the ADCs by Pipes.

}

The Warsaw Pact variant served in the air forces of Bulgaria, Czechoslovakia, East Germany, Hungary, Poland, and Romania. The Third World variant served in the air forces of Algeria (from 1982), Cuba, Egypt, India (in the 1980s), Iraq (prior to 1980), Libya (from 1984), and Syria.%
...
The MiG-23MS is a downgraded version of the MiG-23M for export.
Much of the sensitive avionics are replaced with equivalents from the MiG-21S.
Its NATO reporting name is Flogger-F.%
\note{MiG-23MS ADC and Technical Data}{
    See Mladenov, Goebel, and Wikipedia on the MiG-23. The ADC is largely based on the 23M with radar from the MiG-21S and ECM from the MiG-23MF Third World variant.
}
...
The MiG-23ML has a redesigned and lightened fuselage,  a more powerful R-35F-300 engine with 18,850~lb of dry thrust and 28,800~lb of afterburner thrust, and improved avionics. The Sapfir-23ML radar has a considerably improved look-down/shoot-down capability compared to the previous the Sapfir-23D-III and both an R-23R RHM and an R-23T IRM can be employed on the same mission. The internal fuel capacity is slightly reduced.
...
The MiG-23S/MS, with their radar and fire-control system derived from the MiG-21S, can only carry R-3S and R-13M IRMs and R-3R RHMs. The MiG-23/23M/MF/ML can carry the R-23R RHM or R-23R IRM (AA-7 Apex), but the MiG-23/23M/MF can only carry one kind at time, and the MiG-23M/MF/ML can also carry the R-60/60M IRM (AA-8 Aphid) on a MDR.%
