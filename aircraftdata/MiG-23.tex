...
It is equipped with the R-27F-300 or R-27F2-300 engine and early wings with leading- and trailing-edge flaps for better take-off and landing performance. The wings can be set to a forward position for low-speed flight, a middle position for a balance of speed and maneuverability, and a rear position for high-speed flight.

The MiG-23S is equipped with the RP-22SM Sapfir-21 (Jay Bird) radar from MiG-21S/SM, as the intended RP-23 Sapfir-23 radar was not ready.
It also lacks the IRST and HUD of later versions.

In addition to the internal 23~mm GSh-23L cannon, it has two stations under the wing gloves and two more under the fuselage for R-3S or R-13M (AA-2 Atoll) IRMs, R-3R (AA-2 Atoll) RHMs, or air-to-ground ordnance including the Kh-23 (AA-7 Kerry) RG.
...
It continues to use the R-27F2-300 engine of later MiG-23S aircraft, but has a modified fuselage with the tail surfaces moved to the rear and wings with 20\% greater surface area but without flaps.

It is equipped with the Sapfir-23L (High Lark A) radar. However, while a great improvement on the Sapfir-21 radar of the MiG-21S, this version of the radar lacks the look-down/shoot-down capability of later versions.
It is also equipped with an IRST and HUD.

Its principal armament is a pair of R-23R RHMs or R-23T IRMs (AA-7 Apex), but only one kind can be carried on each mission.
The secondary armament is a pair of R-3S or R-13M (AA-2 Atoll) IRMs.
...
It is powered by an improved R-29-300 engine, capable of 18,400~lb of dry thrust and 25,500~lb with afterburner. The wings were changed again, retaining the greater area of those of the MiG-23 but regaining leading-edge slats for improved performance on take-off and landing. The new wings also have two fixed stations for 800L FTs, the use of which requires the wings to remain in the forward position until the FTs are jettisoned.

The MiG-23M is equipped with the Safir-23D (High Lark II) radar (later upgraded to the Safir-23D-III), with a look-down/shoot-down capability.
...
\note{MiG-23MS ADC and Technical Data}{
    See Mladenov, Goebel, and Wikipedia on the MiG-23. The ADC is largely based on the 23M with radar from the MiG-21S and ECM from the MiG-23MF Third World variant. The HUD Interface is from Malcolm Pipes' ADC.
}

The RP-22SM (Jay Bird) radar, previously used in the MiG-21S and MiG-23S, replaces the Sapfir-23L, and so the MiG-23MS uses the less effective R-3R (AA-2 Atoll) RHM rather than the R-23R (AA-7 Apex). Similarly, the R-3S and R-13M IRMs are used instead of the R-23T. The IRST and ECM equipment are also removed.
...
The Sapfir-23D-III radar is also retained, but is redesignated as Sapfir-23E, as is the capability to use R-23R/T RHM/IRMs (AA-7 Apex).
...
The Third World variant has degraded ECCM for the radar and other avionics, and was only supplied with the R-80 (AA-8 Aphid) IRM starting in 1981.%
\note{MiG-23MF ADC and Technical Data}{
    ...
    \noteparagraph{Third World Variant} The Third World variant has degraded radar ECM/ECCM (which I take to be a radar ECCM of 0, no auto-track, RWR-A instead of B, and no AJM), no datalink, and the R-60 only from 1981. The degraded ECM/ECCM and the radar is largely taken Malcolm Pipes' ADC.

}

The MiG-23MF was manufactured from 1978 to 1983.
The Warsaw Pact variant served in the air forces of Bulgaria, Czechoslovakia, East Germany, Hungary, Poland, and Romania, and the Third World variant served in the air forces of Algeria (from 1982), Cuba (from 1984), India (from 1980), Iraq (from 1981), Libya (from 1984), and Syria (from 1978).%
...
The MiG-23MLA was manufactured from 1975 to 1978. It entered service with the VVS in 1976.%
...
\note{MiG-23MLA ADC and Technical Data}{
    ...
    I am assuming that the Export version has ECCM of zero, RWR-A only, and cannot use R-24s.
}

The airframe of the MiG-23MLA is identical to that of the MiG-23ML, but the radar, gunsight, and missile systems are significantly improved. The Sapfir-23MLA radar has better range, reliability, ECM, and avoids mutual interference. The longer-ranged and more lethal R-24R/T (AA-7C/D Apex) RHMs/IRMs can be carried.

The Warsaw Pact variant was very similar to the base variant for the VVS. The export variant had downgraded radar, weapons systems, and ECM/ECCM.

The MiG-23MLA was manufactured from 1978 to 1983. It entered service with the VVS in 1976 and with the air forces of Bulgaria, Czechoslovakia, and East Germany in 1981. The export version entered service with the air forces of Angola, Cuba, Iraq, North Korea, and Yemen in the early 1980s.%
\note{MiG-23ML Service History}{
    See Mladenov, Goebel, and Wikipedia on the MiG-23.
}
...
The MiG-23S/MS, with their radar and fire-control system derived from the MiG-21S, can only carry R-3S and R-13M IRMs and R-3R RHMs.

The MiG-23/23M/MF/ML can carry the R-23R RHM or R-23T IRM (AA-7A/B Apex) on the wing-glove stations, but the MiG-23/23M/MF can only carry one kind at time, and the R-3S or R-13M IRMs on the fuselage stations. The MiG-23MLA can carry the improved R-24R RHM or R-24T IRM (AA-7C/D Apex) from 1981.

The MiG-23M/MF/ML can also carry the R-60/60M IRM (AA-8 Aphid) on the fuselage stations, either singly or in pairs on MDRs.%
